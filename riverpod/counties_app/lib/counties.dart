...
List getCounties() {
  var x = countiesData.map((e) => e['name']).toList();
  return x;
}

List getSubcounties(String city) {
  var x = countiesData.firstWhere((element) => element['name'] == city);
  return x['sub_counties'] as List;
}

List countiesList = getCounties();

final pickedCityProvider = StateProvider<String?>(((ref) => null));
